...
<div class="invoice-invoiced">
  <div class="header">
    <img src="<?php print drupal_get_path('theme', 'ths') . "/logo.png"; ?>"/>
  ...
  <div class="invoice-header-date">Fecha: <?php print render($content['invoice_header_date']); ?></div>
  ...
  <br>
  <div class="customer"><?php print render($content['commerce_customer_shipping']); ?></div>
  <br>
  ...
  <div class="invoice-footer">
  	<?php print render($content['invoice_footer']); ?>
  </div>
</div>
<?php //exit(); ?>